        ...
        <div className="invoice">
            ...
            <div>
                ...
                <h3 className='text-center mt-1 mb-2 invoice-title'>
                    <strong>
                        {isProforma ? 'فاتورة تحضيرية - Proforma Invoice' : 'فاتورة بيع ذمم - Receivable Invoice'
                        }
                    </strong>
                </h3>
               <Row>
                ...
                <Row className='mt-1'>
                    <Col>
                        {/* Use colgroup to let the "البيان" (name) column take remaining space.
                            Other columns are given small widths and nowrap to fit content. */}
