...
const Print = ({ order, meta: { total, subtotal, discount, subtotalDiscount, fixedDiscount } }) => {
       ...
       <div className="invoice">
            ...
            <div>
                <h3 className='text-center mt-1 mb-2 invoice-title'>
                    <strong>سند تسليم بضاعة - Goods receipt</strong>
                </h3>
                         <Row>
                               <Col>
                                   <h4>
                               ...
                               <Col>
                                   <h4>
                                       <div className='d-flex m-0'>
                                           <span className='font-20'>رقم السند </span>
                                           <span className="underline-dotted flex-grow-1 dotgoods"><strong className='ml-1'>:</strong><strong>{order?.number}</strong></span>
                                       </div>
                                   </h4>
                               </Col>
                           </Row>
  ...
  <table className="table1" style={{ width: '100%', tableLayout: 'auto' }}>
                ...
                <Row className='mt-1'>
                               <Col>
                    <strong>أقرّ أنا المذكورة أعلاه باستلام ما تم ذكره أعلاه بحالة جيدة وخالٍ من أي عيب، وأتحمل المسؤولية الكاملة بعد الاستلام.</strong>
                    </Col>
                </Row>
                      {order?.invoice_notes && (
                          <Row className='mt-0'>
                                ...
                                <Col md={6} sm={6}>
                                    <h4 className="invoice-field">
                                        <div className='d-flex mb-0'>
                                            ...
                                            <span className=" underline-dotted flex-grow-1 dotnamereseve"><strong className='ml-1'>:</strong></span>
                                        </div>
                                    </h4>
                                </Col>
                            </Row>
