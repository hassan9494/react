    ...
    return (
            ...
            <div>
                ...
                <h3 className='text-center mt-1 mb-2 invoice-title'>
                    <strong>
                        {isProforma ? 'فاتورة تحضيرية - Proforma Invoice' : 'فاتورة بيع نقدي - Cash Invoice'
                        }
                    </strong>
                </h3>
               <Row>
                    <Col>
                        <h4>
                            <div className='d-flex m-0'>
                                ...
                                <span className="underline-dotted flex-grow-1 dotdate"><strong className='ml-1'>:</strong><strong>{ moment(order?.taxed_at).format('DD/MM/Y') }</strong></span>
                            </div>
                        </h4>
                    </Col>
                    <Col>
