...
import OfferWithHeaderInvoice from '@components/invoice/offer_with_header'
...
const Print = () => {
    ...
    return (
        <OfferWithHeaderInvoice order={order} meta={calcFinancial(order)} onPageChange={setCurrentPage} />
    )
}
